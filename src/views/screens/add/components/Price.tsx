  ...
  const styles = useMemo(() => {
    return StyleSheet.create({
      ...
      textContainer: {
        ...
        borderRightColor: appTheme.borderDefault
      },
      text: {
        fontSize: hp(FONT_SIZE.h3),
        textTransform: "capitalize"
    ...
    <View style={styles.conditionContainer}>
      ...
      <View style={styles.inputContainer}>
        ...
        <View style={styles.inputContainers}>
          <TextInput style={styles.input} keyboardType={"number-pad"} value={price} placeholder='Enter price' placeholderTextColor={appTheme.borderDefault} onChangeText={val => handlePrice(val)} />
        </View>
      </View>
    </View>
  )
